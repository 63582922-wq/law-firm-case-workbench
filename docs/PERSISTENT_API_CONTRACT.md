...
当前 UUID 路由覆盖事实候选/决定、诉请候选/范围确认/回应、争点候选/确认、交易候选/确认、付款分类候选/批准、重复流水组候选/结论；证据路由另覆盖原件登记、逐页处置候选/批准、红框坐标候选/批准、重复页候选/结论和 Manifest 锁定。请求明确携带案件版本、币种、日期精度、付款性质、债务分配、证据原件哈希与页码；所有写命令必须携带幂等键。
