...
def default_case_skill_registry() -> CaseSkillRegistry:
    ...
    tools = (
        ...
        ToolDefinition("create_docx_draft", "1.0.0", frozenset({CapabilityScope.MANAGED_DERIVATIVE_WRITE}), False, False, True),
        ToolDefinition("create_xlsx_ledger", "1.0.0", frozenset({CapabilityScope.MANAGED_DERIVATIVE_WRITE}), False, False, True),
    ...
    skills = (
        ...
        SkillDefinition("document_drafting", "1.0.0", "答辩状和说明文书草拟", SkillMaturity.GATED, frozenset({CapabilityScope.MANAGED_DERIVATIVE_WRITE}), ("create_docx_draft", "create_pdf_derivative"), ApprovalGate.LAWYER_REVIEW, "DraftDocument", no_original_mutation),
        SkillDefinition("spreadsheet_ledger", "1.0.0", "交易台账与核算表生成", SkillMaturity.GATED, frozenset({CapabilityScope.MANAGED_DERIVATIVE_WRITE}), ("create_xlsx_ledger",), ApprovalGate.LAWYER_REVIEW, "LedgerWorkbook", no_original_mutation),
