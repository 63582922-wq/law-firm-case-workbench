-- Forward-only OCR conservative cost reservation; preserve 0059 history.
...
BEGIN
    ...
    IF task_row.skill_id IS DISTINCT FROM 'image_visual_ocr'
       ...
       OR task_row.sandbox_policy_hash IS DISTINCT FROM
          'b680384ca766966a4e811bc9e6acd48c34844cebf1c1f3735c24b33d2abdae8f'
       ...
       OR COALESCE((task_row.resource_budget->>'max_cost_minor_units')::integer, -1) < 6
